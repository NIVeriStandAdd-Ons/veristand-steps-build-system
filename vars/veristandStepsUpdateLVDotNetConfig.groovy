def call(lv_version, dotnet_config_filepath, veristand_version, teststand_version) {
        ...
        bat "labview-cli --kill --lv-ver ${lv_version} \"L:\\veristand-steps-build-system\\steps\\veristandSteps-lvDotNetConfigFile-update.vi\" -- \"${dotnet_config_filepath}\" \"${dotnet_config_filepath}\" \"${teststand_version}\" \"${veristand_version}\""
}